...
@Controller
@RequestMapping("/ecsite")  //localhost:8080/ecsite/へアクセス
public class IndexController {
	
	//userentityからusertableへアクセス
	@Autowired
	private UserRepository userRepos;
	
// goodsentityからgoodstsbleへアクセス
@Autowired
...
private Gson gson  = new Gson(); //インスタンス化

//トップページに遷移するメソッド
@RequestMapping("/")
public String index(Model m) {
	List<Goods> goods = goodsRepos.findAll(); //goodsテーブルから取得した商品をフロントに渡すModel
...
public String purchaseApi(@RequestBody HistoryForm form) {
